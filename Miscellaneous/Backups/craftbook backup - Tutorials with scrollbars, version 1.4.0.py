...
class GUI:
    def __init__(self,master,name,idnum,craftTop,craftMid,craftLow,craftKey,itemSmelt,itemTool,itemDurability,itemLocation,itemStack,itemPhysics,itemOtherInfo):
        ...
        self.craftingBox.create_text(5,225,text="Location: " + itemLocation,anchor="nw",width=300)
        self.craftingBox.create_text(5,240,text="Stack: " + itemStack,anchor="nw",width=300)
        self.craftingBox.create_text(5,255,text="Physics: " + itemPhysics,anchor="nw",width=300)
        self.craftingBox.create_text(5,270,text="Other Info: " + itemOtherInfo,anchor="nw",width=300)
    ...
    def searchXML(self):
        ...
        GUI.updateWindow(self,name,idnum,craftTop,craftMid,craftLow,craftKey,itemSmelt,itemTool,itemDurability,itemLocation,itemStack,itemPhysics,itemOtherInfo)#runs the update function to update the window with the given information
        
    def updateWindow(self,name,idnum,craftTop,craftMid,craftLow,craftKey,itemSmelt,itemTool,itemDurability,itemLocation,itemStack,itemPhysics,itemOtherInfo):
        self.craftingBox = Tkinter.Canvas(root,width=300,height=350)
        ...
        self.craftingBox.create_text(5,240,text="Stack: " + itemStack,anchor="nw",width=300)
        self.craftingBox.create_text(5,255,text="Physics: " + itemPhysics,anchor="nw",width=300)
        self.craftingBox.create_text(5,270,text="Other: " + itemOtherInfo,anchor="nw",width=300)
    ...
    def aboutDisp(self):
        ...
        titleLabel = Tkinter.Label(aboutWindow,text="Craftbook v. 1.4.0", font="TkHeadingFont", relief="solid", padx="3", pady="5")
        titleLabel.grid(row=0,column=0)
        
        subTitleLabel = Tkinter.Label(aboutWindow,text=" Built for Minecraft 1.4.0\n")
...
class Keybindings:
    def __init(self): #used to instantiate a Keybindings instance so that fns can be called
        return True
...
window = GUI(root,name,idnum,craftTop,craftMid,craftLow,craftKey,itemSmelt,itemTool,itemDurability,itemLocation,itemStack,itemPhysics,itemOtherInfo)#calls the info on the window
